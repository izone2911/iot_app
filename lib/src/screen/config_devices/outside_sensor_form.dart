...
import 'package:quanlyhoctap/src/screen/config_devices/dropdown_time_outside.dart';
                    ...
                    InkWell(
                      onTap: () async {
                        ...
                        awsIotProvider.publish(
                            "check_outside", jsonEncode({"check outside": ""}));
                        ...
                        if (context.mounted) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                              awsIotProvider.dataAws['outside_running']
                                      ['running']
                                  ? SnackBar(
                                      content: const Text(
