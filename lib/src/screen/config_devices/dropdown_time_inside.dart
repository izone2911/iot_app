      ...
      return Column(
        ...
        children: [
          DropdownButton<String>(
            hint: Text(
                '${awsIotProvider.dataAws['inside_changed']['change_time']}'),
            ...
            onChanged: (String? newValue) async {
              if (newValue != null &&
                ...
                if (context.mounted) {
                  ...
                  if (awsIotProvider.dataAws['inside_changed']['change_time'] !=
                      newValue) {
                        awsIotProvider.addDataAws("inside_running", {'running': false, 'time': '10'});
                      }
